...
é recomendado o uso de CSS com Flexbox, uma das abordagens de posicionamento de elementos mais utilizadas quando se trata de responsividade. 
...
Links Úteis: Repositório no GitHub (implementação de referência)
